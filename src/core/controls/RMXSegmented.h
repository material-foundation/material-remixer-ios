...
/** The RMXSegmented class provides a model supporting a segmented picker control. */
@interface RMXSegmented : NSObject <RMXModelItemList>
...
/**
 ...
 @param itemList An array of string items available to the control.
 */
