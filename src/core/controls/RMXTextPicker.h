...
/** The RMXTextPicker class provides a model supporting a text picker control. */
@interface RMXTextPicker : NSObject <RMXModelItemList>
...
/**
 ...
 @param itemList An array of strings available to the control.
 */
